...
const spellData = [
    ...
    { name: "Cigotuvi's Dreadful Rot", level: 2, schools: ["necromancy", "air_magic", "poison_magic"], powerCap: 50, maxVersion: 30 },
    ...
    { name: "Vhi's Electric Charge", level: 3, schools: ["air_magic", "translocations"], powerCap: 50, maxVersion: 30 },
    ...
    { name: "Manifold Assault", level: 4, schools: ["translocations"], powerCap: 100, maxVersion: 31 },
