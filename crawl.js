...
const spellData = [
    ...
    { name: "Cigotuvi's Dreadful Rot", level: 2, schools: ["necromancy", "air_magic", "alchemy"], powerCap: 50, maxVersion: 31 },
    ...
    // From 0.32, this is only "cast" by Gell's Gravitamborine
